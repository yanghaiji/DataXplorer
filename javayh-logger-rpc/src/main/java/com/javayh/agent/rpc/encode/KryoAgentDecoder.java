 ...
 * <p>
 * 服务端解码器
 * https://github.com/yanghaiji/health-monitor/blob/main/javayh-health-monitor-server/src/main/java/com/javayh/health/monitor/server/encode/HeartbeatDecoder.java
 * </p>
 *
 * @author Dylan-haiji
 * @version 1.0.0
